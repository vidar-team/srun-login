...
// Md5 is the internal md5 hash algorithm of srun,
// which can input a parameter as salt value.
func Md5(str, salt string) (string, error) {
	vm := otto.New()
	_ = vm.Set("str", str)
	_ = vm.Set("salt", salt)
	value, err := vm.Run(md5Script)
	if err != nil {
